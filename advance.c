        ...
        switch (op1) {
            ...
            case 2: {
                ...
                do {
                    ...
                    switch (op3) {
                        ...
                        case 2: {           // finding armstrong number
                        ...
                        case 3: {           //finding palindrome number
            ...
            case 4: {
                ...
                do {
                    ...
                    switch (op5) {
                        case 1: {
                            // Matrix Addition logic (to be added)
                            break;
                        }
                        case 2: {
